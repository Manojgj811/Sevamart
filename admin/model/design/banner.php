...
class ModelDesignBanner extends Model {
	public function addBanner($data,$storeid) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "' ,store_id = '" . (int)$storeid . "'");
	...
	public function getBanner($banner_id,$storeid) {
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "banner WHERE banner_id = '" . (int)$banner_id . "' AND store_id = '" . (int)$storeid . "'");
