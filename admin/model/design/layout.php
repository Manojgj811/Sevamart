...
class ModelDesignLayout extends Model {
	public function addLayout($data,$storeid) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "layout SET name = '" . $this->db->escape($data['name']) . "',store_id = '" . (int)$storeid . "'");
	...
	public function getLayoutsBasedOnStore($store_id ) {
		$sql = "SELECT * FROM " . DB_PREFIX . "layout  where store_id=$store_id";
