...
class ModelLocalisationCancelReason extends Model {
	public function addReturnCancel($data) {
	...
	public function editReturnCancel($cancel_reason_id, $data) {
	...
	public function deleteReturnCancel($cancel_reason_id) {
		$this->db->query("DELETE FROM " . DB_PREFIX . "cancel_reason WHERE cancel_reason_id = '" . (int)$cancel_reason_id . "'");

		$this->cache->delete('cancel_reason');
	}

	public function getReturnCancel($cancel_reason_id) {
	...
	public function getReturnCancels($data = array()) {
		if ($data) {
	...
	public function getReturnCancelDescriptions($cancel_reason_id) {
	...
	public function getTotalReturnCancels() {
