...
////// created by sharath  on 31-03-2021 for calculate the total sale  of individual store for store managers

public function getTotalSalesofstore($storeid) {
	$sql = "SELECT SUM(total) AS total FROM " . DB_PREFIX . "order WHERE  order_status_id > '0' And  store_id= '".(int)$storeid ."'";
