...
class ModelCatalogManufacturer extends Model {
	...
	////// display manufactures based on store 

	public function getManufacturersBasedOnStore($data = array() ,$store_id  ) {
		$sql = "SELECT * FROM oc_manufacturer manufacturer LEFT JOIN oc_manufacturer_to_store manufacturer_to_store 
		ON manufacturer.manufacturer_id =manufacturer_to_store.manufacturer_id  where manufacturer_to_store.store_id='" . (int)$store_id . "'   ";
