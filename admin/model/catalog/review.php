...
class ModelCatalogReview extends Model {
	...
	public function getReviews($data = array() ,$store_id ) {
	
		$sql = "SELECT r.review_id, pd.name, r.author, r.rating, r.status,r.store_id,  r.date_added FROM " . DB_PREFIX . "review r LEFT JOIN " . DB_PREFIX . "product_description pd ON (r.product_id = pd.product_id) 
		WHERE pd.language_id = '" . (int)$this->config->get('config_language_id') . "'  and  r.store_id=$store_id";
