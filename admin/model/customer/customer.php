...
class ModelCustomerCustomer extends Model {
	...
	public function getTotalCustomersofstore($store_id ) 
	{
		$sql = $this->db->query( "SELECT COUNT(*) AS total   FROM " . DB_PREFIX . "customer  where  store_id= '".(int)$store_id ."' ");
		
		return $sql->row['total'];
	}
	
    public function getTotalCustomersofstoredetails($store_id) 
	{
		$sql = $this->db->query( "SELECT * FROM " . DB_PREFIX . "customer  where  store_id= '".(int)$store_id ."' ");
		return $sql->rows;
	}
