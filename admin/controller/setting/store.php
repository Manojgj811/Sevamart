...
class ControllerSettingStore extends Controller {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
           ...
           // $this->load->model('setting/StorePincode');
			//$this->model_setting_StorePincode->editStorepin($this->request->post,$this->request->get['store_id']);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			foreach ($this->request->post['selected'] as $store_id) {
				...
				//$this->model_setting_StorePincode->deleteStorepin( $store_id);
	...
	protected function getForm() {
		...
		// if (isset($this->error['cash'])) {
		// 	$data['error_cash'] = $this->error['cash'];
		// } else {
		// 	$data['error_cash'] = '';
		// }
		
	    // if (isset($this->error['accountID'])) {
		// 	$data['error_account'] = $this->error['accountID'];
		// } else {
		// 	$data['error_account'] = '';
		// }
		...
		if (isset($this->request->get['store_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST'))
		 {
			...
			//$store_info = $this->model_setting_setting->getSetting('key', $this->request->get['store_id']);
		//$store_info = $this->model_setting_setting->getSetting('config_cash', 6);
//////////////maincode
	...
	$data['user_token'] = $this->session->data['user_token'];
		...
		$foldername=$data['config_name'];

		@$id=$this->request->get['store_id'];

		$var=DIR_IMAGE .'catalog/'.	$id;
...
////////////
		...
		if (isset($this->request->post['config_account'])) 
		{
		 ...
		 elseif (isset($store_info['config_account'])) {
			$data['config_account'] = $store_info['config_account'];
		}
		 else {
			$data['config_account'] = '';
		}
	...
	if (isset($this->request->post['config_address'])) {
		...
		// }elseif (isset($store_info['config_payment'])) {
		// 	$data['config_payment'] = $store_info['config_payment'];
		// } else {
		// 	$data['config_payment'] = '';
		// }
		
		
		// if (isset($this->request->post['config_cash'])) {
		// 	$data['config_cash'] = $this->request->post['config_cash'];
		// }elseif (isset($store_info['config_cash'])) {
		// 	$data['config_cash'] = $store_info['config_cash'];
		// } else {
		// 	$data['config_cash'] = '';
		// }
	...
	protected function validateForm()
	 {
		...
		// if (!$this->request->post['config_payment']) {
		// 	$this->error['payment'] = $this->language->get('error_payment');
		// }
		// if (!$this->request->post['config_cash']) {
		// 	$this->error['cash'] = $this->language->get('error_cash');
		// }
		// /////for account
		// if (!$this->request->post['config_account']) {
