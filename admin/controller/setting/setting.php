...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['cash'])) {
			$data['error_cashpayment'] = $this->error['cash'];
		} else {
			$data['error_cashpayment'] = '';
		}
...
*/
	...
	/*	if (isset($this->request->post['config_payment'])) {
		...
		if (isset($this->request->post['config_cash'])) {
			$data['config_telephone'] = $this->request->post['config_cash'];
		} else {
			$data['config_telephone'] = $this->config->get('config_cash');
		}
