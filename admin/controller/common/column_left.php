...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			// servicearea
			$servicearea = array();
			if ($this->user->hasPermission('access', 'servicearea/servicearea')) {
				$servicearea[] = array(
					'name'	   => $this->language->get('text_servicearea'),
					'href'     => $this->url->link('servicearea/servicearea', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			/*
			if ($this->user->hasPermission('access', 'catalog/servicearea')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_servicearea'),
					'href'     => $this->url->link('catalog/servicearea', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			*/
		...
		if ($this->user->hasPermission('access', 'catalog/product')) {
			...
			$users=$this->model_user_user->getUser($this->user->getId());
	 
		 if($users)
		 {
			 $data['user_group'] = $users['user_group_id'];
	 
		
			   if ($this->user->hasPermission('access', 'extension/export_import')) {
					 $catalog[] = array(
						 'name'	   => $this->language->get('text_uploadproducts'),
						 'href'     => $this->url->link('extension/export_import', 'user_token=' . $this->session->data['user_token'], true),
						 'children' => array()		
					 );
				 }

				 if ($this->user->hasPermission('access', 'extension/inventory')) {
					$catalog[] = array(
						'name'	   => $this->language->get('text_inventory'),
						'href'     => $this->url->link('extension/inventory', 'user_token=' . $this->session->data['user_token'], true),
						'children' => array()		
					);
				}
			...
			if ($this->user->hasPermission('access', 'sale/pos')) 
			{
				$sale[] = array(
					...
					'href'     => $this->url->link('sale/pos', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}

			if ($this->user->hasPermission('access', 'sale/pos_return')) 
			{
				$sale[] = array(
					'name'	   => $this->language->get('text_return'),
					'href'     => $this->url->link('sale/pos_return', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			...
			if ($this->user->hasPermission('access', 'sale/return')) {
				$sale[] = array(
					'name'	   => $this->language->get('text_customer_request'),
			...
			if ($this->user->hasPermission('access', 'storecontract/storecontract')) {
				$system[] = array(
					'name'	   => $this->language->get('text_storecontract'),
					'href'     => $this->url->link('storecontract/storecontract', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}

			if ($this->user->hasPermission('access', 'storesubscription/storesubscription')) {
				$system[] = array(
					'name'	   => $this->language->get('text_storesubscription'),
			...
			if ($this->user->hasPermission('access', 'localisation/cancel_reason')) {
				$return[] = array(
					'name'	   => $this->language->get('text_cancel_reason'),
					'href'     => $this->url->link('localisation/cancel_reason', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
