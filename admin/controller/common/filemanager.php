	...
	public function index() {
		...
		$user_info = $this->model_user_user->getUser($this->user->getId());
		 ...
		 { 
			...
			{ 
				$storefolderID=	$user_info['store_id'];
			}
			else
			{
				$storefolderID=	'';
		...
		{
				$directory = DIR_IMAGE . 'catalog/'.$storefolderID.'/';
		}
	...
	public function upload() {
	   ...
	   if($user_info)
		...
		if (isset($this->request->get['directory'])) 
		{
				...
				{
					$directory = rtrim(DIR_IMAGE .'catalog/'.$storefolderID.'/' );

					//echo "14 executed";var_dump($directory );
				...
				//echo "14 executed inside sub"; var_dump($directory );
