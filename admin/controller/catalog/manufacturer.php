...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getList() {
		...
		$storeManagerResultsManufacturers = $this->model_catalog_manufacturer->getManufacturersBasedOnStore( $filter_data ,  $user_info['store_id']  );

		foreach ($storeManagerResultsManufacturers as $result) {
	...
	protected function getForm() {
		...
		/// to dispaly store maanger store name 
		...
		if($user_info)
		{
			...
			{
			if($user_info['store_id']==$store['store_id'])
				{
					// echo $user_info['store_id'];// echo "<br>";// echo $store['store_id'];
	...
	protected function validateDelete() {
		...
		$getManufacturersByStore = $this->model_catalog_manufacturer->getManufacturersBasedOnStore( $filter_data ,$user_info['store_id']  );

		foreach ($getManufacturersByStore as $result) 
		{
			if( $user_info['user_group_id'] !=1  )
