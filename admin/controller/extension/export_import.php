               ...
               if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateUploadForm()))
					 {
						if ((isset( $this->request->files['upload'] )) && (is_uploaded_file($this->request->files['upload']['tmp_name']))) 
						{
							...
							if ($this->model_extension_export_import->upload($file,$this->request->post['incremental'],$current_store_id)==true)
							{
					...
					switch ($export_type) {
						...
						case 'u':
							...
							if (($min==null) || ($max==null)) {
								...
								$this->model_extension_export_import->download($export_type, null, null, null, null, $current_store_id);
