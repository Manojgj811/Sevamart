...
/* user/user_form.twig */
class __TwigTemplate_00c1f715c8834bf2146263eb3b2b5d1f0240c27e4e5b69e592e7e58fc700ea89 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<!------------------------>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["store"]) {
            // line 60
            echo "                ";
            if ((twig_get_attribute($this->env, $this->source, $context["store"], "store_id", [], "any", false, false, false, 60) == twig_get_attribute($this->env, $this->source, $context["store"], "store_id", [], "any", false, false, false, 60))) {
                // line 61
                echo "                <option value=\"";
