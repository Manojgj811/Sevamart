...
/* user/user_form.twig */
class __TwigTemplate_4b8e4c7b85aebc86ab65220ab775ad0cd9cb6b9b1ace355fd68b1e2a8321697e extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container-fluid\">
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["user_groups"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["user_grou"]) {
            // line 57
            echo "                ";
            if ((twig_get_attribute($this->env, $this->source, ($context["user_group"] ?? null), "user_group_id", [], "any", false, false, false, 57) == ($context["user_group_id"] ?? null))) {
                // line 58
                echo "                <option value=\"";
                echo twig_get_attribute($this->env, $this->source, ($context["user_group"] ?? null), "user_group_id", [], "any", false, false, false, 58);
                echo "\" selected=\"selected\">";
                echo twig_get_attribute($this->env, $this->source, ($context["user_group"] ?? null), "name", [], "any", false, false, false, 58);
                echo "</option>
                ";
            } else {
                // line 60
                echo "                <option value=\"";
                echo twig_get_attribute($this->env, $this->source, ($context["user_group"] ?? null), "user_group_id", [], "any", false, false, false, 60);
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, ($context["user_group"] ?? null), "name", [], "any", false, false, false, 60);
                echo "</option>
                ";
            }
            // line 62
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['user_grou'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 63
        echo "              </select>
            </div>
