...
/* user/user_form.twig */
class __TwigTemplate_3186e3dc3b5e472f39f39bb5d8939dfe3872039e61bb49c3cdca58b2092a822b extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"panel-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user_group"]) {
            ...
            if ((twig_get_attribute($this->env, $this->source, $context["user_group"], "user_group_id", [], "any", false, false, false, 57) == ($context["user_group_id"] ?? null))) {
                ...
                echo "\" selected=\"selected\">";
                echo twig_get_attribute($this->env, $this->source, ($context["use_group"] ?? null), "name", [], "any", false, false, false, 58);
                echo "</option>
                ";
            } else {
                // line 60
