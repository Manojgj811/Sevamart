...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) 
		{
			...
			if($customer_info){
				...
				$customer_id = $this->model_account_customer->updateCustomer($this->request->post);

			}
			else{
			        $customer_id = $this->model_account_customer->addCustomer($this->request->post);
			}
			// Clear any previous login attemptss for unregistered accounts.
		...
		//	echo "the registered and login customer id is $cId";
		...
		}else if(isset($this->request->get['firstname'])) {
		...
		} else if(isset($this->request->get['telephone'])) {
	...
	private function validate() {
		...
		if ($this->model_account_customer->getTotalCustomersByMobileNumber($this->request->post['telephone'])) {

			$customer_info = $this->model_account_customer->getCustomerByTelephone($this->request->post['telephone']);

			if(trim($customer_info['email']) != ""){
			$this->error['warning'] = $this->language->get('error_mobilenumberexists');
			}
		}
		...
		if ($this->request->post['config_country_id'] == '' || !is_numeric($this->request->post['config_country_id'])) {
			$this->error['country'] = $this->language->get('error_country');
		}

		if (!isset($this->request->post['config_zone_id']) || $this->request->post['config_zone_id'] == '' || !is_numeric($this->request->post['config_zone_id'])) {
