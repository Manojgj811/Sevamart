	...
	public function index() {
		...
		if (!empty($this->request->get['token'])) {
			...
			if ($customer_info && $this->customer->login($customer_info['email'], '', true)) {
				...
				$this->response->redirect($this->url->link('account/stores', '', true));
			}
		}
		...
		if($_COOKIE['sevaMartLoginOtp'] != $this->request->post['enteredOtp']){
		  ...
		  //return;
			...
			if(trim($customer_info['email']) == ""){
				$this->response->redirect($this->url->link('account/register', 'telephone=' . $this->request->post['mobile'] .'&firstname='.$customer_info['firstname'], true));
			}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('account/stores', '', true)
		);
